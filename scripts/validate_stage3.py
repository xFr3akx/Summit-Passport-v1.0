...
app=json.loads((A/'catalog.json').read_text(encoding='utf-8'));working=json.loads((R/'data/catalog_working.json').read_text(encoding='utf-8'))['records']
...
report={'version':app['version'],'map_points':counts,'catalog_sha256':hashlib.sha256((A/'catalog.json').read_bytes()).hexdigest(),'frozen':True,'near_me_stage':7,'catalog_complete':False}
